...
#[clap(version)]
pub enum Cli {
    /// Run the sqlet setup hooks to generate the config file
    Setup,

    /// Sqlet's main migrate operation
    Migrate(MigrateArgs),
...
pub struct MigrateArgs {
    ...
    #[clap(short, default_value = "./sqlet.toml")]
    pub config: PathBuf,
    ...
    /// Do not actually run migrations, just create and update sqlet's schema migration table
    #[clap(short)]
    pub fake: bool,
    ...
    #[clap(long, default_value = "sqlet_schema_history")]
